	...
	<body>
		...
		<div id="contents">
			<?php
				...
				{
				echo "<tr>
						<td><center><a href='grpdetails.php?uiid=$srrws[0]'>$srrws[0]</a></center></td><td>	</td>
						<td><table><tr>$srrws[1]<br></tr>
						<tr>$srrws[2]<br></tr>
						<tr>$srrws[3]</tr></table></td><td>	</td><td>	</td>";
						...
						{
							echo "<td><center><table><tr>$srrwsn1[6]<br></tr>
								<tr>$srrwsn2[6]<br></tr>
								<tr>$srrwsn3[6]</tr></table></center></td><td>	</td>";
							echo "<td><center><table><tr>$srrwsn1[7]<br></tr>
								<tr>$srrwsn2[7]<br></tr>
								<tr>$srrwsn3[7]</tr></table></center></td><td>	</td>";
							
							echo "<td><table><tr><a href='updatemarks.php?uid=".$srrws[1]."'>Update</a><br></tr>
								<tr><a href='updatemarks.php?uid=".$srrws[2]."'>Update</a><br></tr>
								<tr><a href='updatemarks.php?uid=".$srrws[3]."'>Update</a></tr></table></td><td>	</td></tr>";
